...
from poliastro.bodies import Earth, Sun, Uranus
from poliastro.twobody import Orbit

def check_uran_orbit(date, v, m, Isp):
    # sprawdzenie czy orbita została osiągnieta
    date_iso = time.Time(str(date.iso), format='iso', scale='utc')
    r_out=Orbit.from_body_ephem(Uranus, date_iso)      # polozenie Uranu po manewrach
